  ...
  context "and creates an account" do
    ...
    context "as MANAGER" do
      it 'from root page' do
        ...
        expect(current_path).to eq new_manager_registration_path
        expect(page).to have_content 'Novo administrador'
        within '.FORM-SIGNUP' do
          expect(page).to have_field 'Nome'
          expect(page).to have_field 'E-mail'
          expect(page).to have_field 'Senha'
      ...
      it 'successfully' do
        ...
        within 'header' do
          expect(page).not_to have_link 'Entrar'
          expect(page).to have_content 'Olá, Marcos Áries'
          expect(page).to have_button 'Sair'
        end
      ...
      it 'leaving missing information' do
        ...
        within '.FORM-SIGNUP' do
          expect(page).to have_field 'E-mail', with: 'marcos_aries@manager.com'
        end
